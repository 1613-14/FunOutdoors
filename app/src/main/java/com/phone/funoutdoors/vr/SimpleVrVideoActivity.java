package com.phone.funoutdoors.vr;
...
public class SimpleVrVideoActivity extends Activity {
    ...
    private void handleIntent(Intent intent) {
        ...
        fileUri = Uri.parse("http://video.quhuwai.cn/qj24.mp4");
        ...
        protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
            try {
                if (fileInformation == null || fileInformation.length < 1
                    ...
                    Uri path = Uri.parse("http://video.quhuwai.cn/qj24.mp4");
                    videoWidgetView.loadVideo(path, fileInformation[0].second);
                }
            } catch (IOException e) {
                ...
                videoWidgetView.post(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(SimpleVrVideoActivity.this, "Error opening file. ", Toast.LENGTH_LONG)
                                .show();
                    }
                });
